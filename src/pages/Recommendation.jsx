    ...
    useEffect(() => {
        const fetchMoviesInfo = async (id) => {
            ...
            const options = {
                method: 'GET',
                headers: {
                    'x-rapidapi-key': 'c8a86f2abbmsh2c6855891e4cf2ep18f401jsn733e45d6778e',
            ...
            <div style={{
                ...
                {new Array(4).fill(0).map((_, idx) => (
                    <div key={idx} style={{
                        ...
                        <img src={response.results.image_url} width={100} height={200} alt={response.results.title} style={{
                            borderRadius: "12px",
                        }} />
                        <h1>{response.results.title}
                            <p>{response.results.plot}</p>
                        </h1>
